...
enum LoveMsgURL {
  ...
  // 土味情话
  saylove = 'http://api.tianapi.com/saylove/index?key=b8208a7a7f30e33107d9db0875439fa6',
  // 舔狗
  doglove = 'http://api.tianapi.com/tiangou/index?key=b8208a7a7f30e33107d9db0875439fa6',
  // 彩虹屁
...
class API {
  ...
  // 舔狗
  async getDoglove() {
    const res = await getTian<SayloveProps[]>({ url: LoveMsgURL.doglove })
    return res?.[0]
  }
